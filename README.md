...
- [Build 7.0: Global Consensus Aggregator](CHANGELOG.md#build-70-global-consensus-aggregator)
...
- [Build 3.0: The CONSENSUS Event](CHANGELOG.md#build-30-the-consensus-event)
